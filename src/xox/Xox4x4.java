...
public class Xox4x4 {
    ...
    static int sayac = 1;
    static   JPanel panel = new JPanel(new GridLayout(4, 4));
    static JButton[][] buttons = new JButton[4][4];
    //butonlara basılıp basılmadıgını kontrol eder
    static boolean[][] buttonClicked = new boolean[4][4];
    static JFrame frame;
    public static void xox4x4(){
    ...
    if (buttons[0][3].getText().equals(x_or_O) && buttons[1][2].getText().equals(x_or_O) && buttons[3][1].getText().equals(x_or_O)) {
        ...
        gamer++;
        System.out.println("Çapraz sağdan sola");
    }if (buttons[1][3].getText().equals(x_or_O) && buttons[2][2].getText().equals(x_or_O) && buttons[3][1].getText().equals(x_or_O)) {
        gamer++;
    }
